...
/**
 * @author sunzihan
 * @version $Id: ClassUtil.java V 0.1 3/15/17 16:56 sunzihan EXP $
 */
public class ClassUtil {
    ...
    private static String getClassName(String className, boolean processInnerClass) {
        if (com.alibaba.common.lang.StringUtil.isEmpty(className)) {
            return className;
        }
    ...
    public static boolean isInnerClass(Class clazz) {
        ...
        return com.alibaba.common.lang.StringUtil.contains(clazz.getName(), INNER_CLASS_SEPARATOR_CHAR);
    }
