package com.basic.leanring.java.util.enums;
...
/**
 * @author sunzihan
 * @version $Id: BigIntegerEnum.java V 0.1 3/15/17 19:34 sunzihan EXP $
 */
public abstract class BigIntegerEnum extends com.basic.leanring.java.util.Enum {

    private static final long serialVersionUID = -3224909643749550020L;
    ...
    protected static Object createEnumType() {
        return new com.basic.leanring.java.util.Enum.EnumType() {
